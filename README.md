...
This Todo application allows users to manage their tasks efficiently by organizing them based on priority, user assignment, and status. You can also order tasks by title or priority to streamline your workflow.

## Features

- **Group by**: Priority, User, and Status
- **Order by**: Title or Priority
